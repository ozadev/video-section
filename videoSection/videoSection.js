...
(function () {
  ...
  angular.module('videoSection', [
    "com.2fdevs.videogular",
    "com.2fdevs.videogular.plugins.controls",
    "com.2fdevs.videogular.plugins.overlayplay"
  ]);

  angular.module('videoSection').directive('videoSection',
    function () {
      return {
        restrict: 'AE',
        replace: true,
        ...
        template: [
          '<div class="video-slicer-container">',
            '<videogular vg-start-time="vm.videoStartTime" vg-virtual-clip-duration="vm.virtualDuration">',
              '<vg-media vg-src="vm.sources" vg-type="video">',
              '</vg-media>',
              '<vg-controls>',
